...
class GaussianTSLearner(BanditLearner):
    ...
    def _select_price_criteria(self, product: Product) -> List[float]:
        return [(np_random.standard_normal() / (np.sqrt(self.parameters[product.id][i].t_0)) +
    ...
    def _update(self):
        ...
        ### Because we are not using the data value of how many customers have been served.
        ### TODO: But why aren't we using it IDK
